...
?>
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="full_name" placeholder="Client full name" value="<?php echo $client->full_name; ?>" required="required" />
                      </div>
                      <div class="form-group">
				     ...
				     <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <input type="submit" class="btn btn-primary" value="<?php if(isset($_POST['edit_client'])){ echo 'Update Client'; } else { echo 'Add Client';} ?>" />
                    </form>
                    <script>
